...
require([
    ...
    Parcels = new FeatureLayer({
        url: "https://arcgis.ucanr.edu/server/rest/services/ALOSAC/ALOSAC_Data/MapServer/",
        layerId: 4,
        blendMode: "multiply",
        title: "Parcels"
    });
